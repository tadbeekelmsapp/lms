...
You need to be at least 13 years old to register for and use the Service. If, you are a user who signs up for the Service, we will create a personalized account, which includes a unique username and a password to access the Service and to receive messages from the Company. You agree to notify us immediately of any unauthorized use of your password and/or account. The Company will not be responsible for any liabilities, losses, or damages arising out of the unauthorized use of your member name, password and/or account.
...
The Company is not responsible for any public display or misuse of your User Content. The Company does not, and cannot, pre-screen or monitor all User Content. However, at our discretion, we, or the technology we employ, may monitor and/or record your interactions with the Service.
...
As part of the Service, the Company may provide you with convenient links to third party web site(s)
(“Third Party Sites”) as well as content or items belonging to or originating from third parties (the ”Third Party Applications, Software or Content”). These links are provided as a courtesy to Service subscribers. The Company has no control over Third Party Sites and Third Party Applications, Software or Content or the promotions, materials, information, goods or services available on these Third Party Sites or Third Party Applications, Software or Content. 
...
If you decide to leave the Site and access the Third Party Sites or to use or install any Third Party Applications, 
...
Works at a single online site are recovered by a single notification, a representative list of such works at that site;
...
We reserves the right at any time, to amend, alter, modify, or change, as it sees fit, any term of these terms without any prior notice. We will post modified versions of the terms and condition on our website and note the last revised date at the bottom of these terms and conditions. We encourage you to review these terms and conditions every time you use this website. Your use of this website constitutes your agreement to follow and be bound by the most recent version of the terms and conditions

We may offer a service known as "Featured Ads" where users may pay a non-refundable fee to have their ads posted in selected locations on the Website, thus potentially increasing an ads' visibility. 
In order to purchase a Featured Ad, you may be required to transmit certain information through a third party service provider, which may be governed by its own terms & conditions and other policies. 

We make no representation or guarantee as to the safety or security of the information transmitted to any Third Party service provider, and your linking to any Third Party service is completely at your own risk, and we disclaims all liability related thereto.
...
Other product and business names that are mentioned on the Service may be trademarks of their respective owners. We reserve all rights that are not expressly granted to you under this Agreement.
...
PARTICULAR, PURPOSE, TITLE, SECURITY, ACCURACY AND NON-INFRINGEMENT. WITHOUTLIMITING THE FOREGOING, THE COMPANY MAKES NO WARRANTY OR REPRESENTATION THAT ACCESS TO OR OPERATION OF THE SERVICE WILL BE UNINTERRUPTED OR ERROR FREE. YOU ASSUME FULL RESPONSIBILITY AND RISK OF LOSS RESULTING FROM YOUR DOWNLOADING AND/OR USE OF FILES, INFORMATION, CONTENT OR OTHER MATERIAL OBTAINED FROM THE SERVICE. SOME JURISDICTIONS LIMIT OR DO NOT PERMIT DISCLAIMERS OF WARRANTY, SO THIS PROVISION MAY NOT APPLY TO YOU.

LIMITATION OF DAMAGES; RELEASE
TO THE EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL THE COMPANY,
ITS AFFILIATES, DIRECTORS, OR EMPLOYEES, OR ITS LICENSORS OR PARTNERS, BE
LIABLE TO YOU FOR ANY LOSS OF PROFITS, USE, OR DATA, OR FOR ANY INCIDENTAL,
INDIRECT, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, HOWEVER ARISING,
THAT RESULT FROM 
...
These Terms of Use and your use of the Site are governed by the laws of the Kuwait, without regard to conflict of law provisions.
...
REPRESENT THE COMPLETE AND EXCLUSIVE STATEMENT
