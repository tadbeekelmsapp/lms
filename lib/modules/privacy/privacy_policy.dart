    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: const [
            Text('''
We place the utmost importance on your privacy and do our best to preserve it. We have fashioned this privacy policy to describe in detail to you the way in which any personal information made available to us through your use of the Tadbeeke.com will be used and/or shared.
In line with KW data protection laws and EU regulations, specifically the General Data Protection Regulation (GDPR) we have obtained your consent and your continued use of our website shall be taken as an acceptance of our privacy policy. Should you not agree with this privacy policy, your recourse is to stop using our website in any form or manner.
...
General
It governs the privacy terms of our Website, sub-domains, and any associated web-based and mobile applications (collectively, "Website"), as owned and operated by Creators Educational Services. Any capitalized terms not defined in our Privacy Policy, have the meaning as specified in our Terms of Service.
Your privacy is very important to us. Accordingly, we have developed this Policy in order for you to understand how we collect, use, communicate and disclose and make use of personal information. We use your Personal Information only for providing and improving the website. By using the website, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions. The following outlines our privacy policy.
...
Under the Child's Online Privacy Security Act, no Website operator can require, as a condition to involvement in an activity, that a child younger than 13 years of age divulge more details than is reasonably required. Creators Educational Services  abides by this demand. Creators Educational Services  just collects information willingly offered; no information is gathered passively. children under 13 can submit only their email address when sending us an email in our "Contact Us" area. Creators Educational Services  makes use of the email address to respond to a one-time demand from a child under 13 and afterwards deletes the email address. In case Creators Educational Services  collects and maintains personal information relating to a child under 13, the parent may send out an email to us to review, alter and/or erase such info as well as to decline to enable any additional collection or use of the child's information.
